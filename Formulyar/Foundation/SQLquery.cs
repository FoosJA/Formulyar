...
namespace Formulyar.Foundation
{
    ...
    {
        #region Список ОТИ
        public const string OtiCodesQuery =
             @"
...
order by oti.TypeOI, NumbOti
        ...
        //            ";
        #endregion
        public const string OtiAIPQuery = @"
select * 
from (
...
";
        #region Список КПОС
        public const string SechQuery = @"
select *
from LSA_test..KPOS
order by DCsource, NameKS,TypeOI, NumbOI";
        #endregion
        #region Список МУН
        public const string MUNQuery = @"
...
order by DCsource,EnergyObject,NumbTiItog";
        #endregion
        #region Список АОПО
        public const string AOPOQuery = @"
select * 
from LSa_test..SMTN_AOPO
order by DC, EquipmentName, EnergyObject,NumbTIsetting";
        #endregion
        #region Список СМТН ЛЭП
        public const string SmtnLineQuery = @"
select *
from LSA_test..SMTN_Line";
        #endregion
        #region Список СМТН АТ(Т)
        public const string SmtnTransformQuery = @"
select *
from LSA_test..SMTN_Transform";
        #endregion
        #region Список СМТН Выкл
        public const string SmtnBreakerQuery = @"
select *
from LSA_test..SMTN_Breaker";
        #endregion
        #region Список СМТН Доп
        public const string SmtnExtraQuery = @"
select *
from LSA_test..SMTN_Dop";
        #endregion
        #region Список Получателей
        public const string DcReceiverQuery = @"select * from Lsa_test..DCReception";
        /// <summary>
        /// Список получателей
        /// </summary>
        /// <param name="oti"></param>
        /// <returns></returns>
        public static string OtiReception(OperTechInform oti)
        {
            var dc = oti.DispatchCenter;
            var numb = oti.NumberOI;
            var type = oti.TypeOI;
            string query = @"

/******Собственно сам запрос ЛСА********************************************************************/
...
";
        ...
        public const string DcTransmitQuery = @"select * from Lsa_test..DCTransmit";
        /// <summary>
        /// Список источников
        /// </summary>
        /// <param name="oti"></param>
        /// <returns></returns>
        public static string OtiSource(OperTechInform oti)
        {
            var dc = oti.DispatchCenter;
            var numb = oti.NumberOI;
            var type = oti.TypeOI;
...
";
        ...
        #endregion
        #region Список проверки КПОС
        public const string CheckInfoKPOS = @"
...
";
        #endregion
        #region Список проверки МУН
        public const string CheckInfoMUN = @"
...
";
        #endregion
        #region Список проверки СМТН_ЛЭП
        public const string CheckInfoSMTN_Line = @"
...
";
        #endregion
        #region Список проверки СМТН_АТ(Т)
        public const string CheckInfoSMTN_Transform = @"
...
";
        #endregion
        #region Сохранение АОПО
        /// <summary>
        /// Сохранение АОПО
        /// </summary>
        /// <param name="oti"></param>
        /// <returns></returns>
        public static string saveAopo ()
        {            
            string query = @"select * from LSA_test..Smtn_Aopo";
            return query;
        }
        public static string savePasport()
        {
            string query = @"select* from
 LSA_test..PTIpasport";
            return query;
        }
        public static string saveApp()
        {
            string query = @"select* from
 LSA_test..ApplicationOTI";
            return query;
        }
        #endregion
        #region Список общих Сечений для главного ДЦ
        /// <summary>
        /// Список общих Сечений для главного ДЦ
        /// </summary>
        /// <param name="mainDc"></param>
        /// <returns></returns>
        public static string CommonSech(string mainDc)
        {
            return @"
declare @MAIN_DC varchar(max)
set @MAIN_DC='" + mainDc + @"' 
select * 
from LSA_test..commonSech
where DC1=@MAIN_DC or DC2=@MAIN_DC
";
        }
        public static string CommonSech()
        {
            return @"
...
";
        ...
        #endregion
        #region Список общих объектов МУН для главного ДЦ
        /// <summary>
        /// Список общих Сечений для главного ДЦ
        /// </summary>
        /// <param name="mainDc"></param>
        /// <returns></returns>
        public static string CommonVoltage(string mainDc)
        {
            return @"
declare @MAIN_DC varchar(max)
set @MAIN_DC='" + mainDc + @"' 
select * 
from LSA_test..commonVoltage
where DC1=@MAIN_DC or DC2=@MAIN_DC
";
        }
        public static string CommonVoltage()
        {
            return @"
...
";
        ...
        public static string CommonLine()
        {
            return @" 
select * 
from LSA_test..commonLine
";
        }
        public static string CommonTransform()
        {
            return @" 
select * 
from LSA_test..commonTransform
";
        }
        public static string CommonBreaker()
        {
            return @" 
select * 
from LSA_test..commonBreaker
";
        }
        #endregion
    }
